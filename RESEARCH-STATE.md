...
- **Covered blocks**: 23 (B1-B23)
- **Coverage metric**: 23 / 32 closed (runs 4-5 opened 11 new gaps)
...
- **Open gaps — read-only investigable**: 9 (G24-G32). Budget cap runs 4-5: +14 blocks (B22-B35). Execution: ORCHESTRATED-AUTO (one fresh sub-agent per iteration; driver gatekeeps via §11 self-reports).

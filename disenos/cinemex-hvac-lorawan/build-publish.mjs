 ...
 *   - unhashed assets (logos, favicons) + the shared, fixed-name protection.js -> short revalidate.
 *
...
# Unhashed assets (logos, favicons) and the shared fixed-name guard: short, must revalidate.
/assets/*
...
//     content-hashed bundles/styles cache immutably for a year; unhashed logos/favicons and the
//     shared protection.js get a short must-revalidate window. New hashed assets or projects must be
//     added to the immutable block by hand.
